...
export default function WateringReminders({ reminders }: WateringRemindersProps) {
              ...
              {items.map((reminder) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <button className="p-1.5 rounded-lg bg-surface-600 hover:bg-emerald-500/20 text-gray-400 hover:text-emerald-400 transition-colors">
